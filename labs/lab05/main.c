...
21.07.22
Implementação de uma Lista Duplamente Encadeada Circular em C. 
O programa deixa voce entrar com um valor e a lista vai adicionando o valor no final lista.
...
int main(void)
{
    ...
    ptLDEC *ptLista = criaLista(); //cria a lista

    while (num !=0) //loop que pede o numero a ser inserido na lista
    {
        print_list(ptLista); //imprime a lista
        printf("Digite um valor para inserir no final da lista(0 para sair): "); //pede o numero a ser inserido na lista
